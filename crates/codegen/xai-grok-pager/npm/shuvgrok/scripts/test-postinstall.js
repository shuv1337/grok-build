...
// postinstall.js and the bin/shuvgrok trampoline.
//
...
// ─── Extracted logic (mirrors postinstall.js and bin/shuvgrok exactly) ─
//
// The fixtures below use the literal binary name 'grok'; the logic under test
// is parameterized by binary name and is identical for 'shuvgrok'.
...
/** Grok bin dir resolution (mirrors postinstall.js and bin/shuvgrok). */
...
/** Bootstrap canonical from vendored (same as bin/shuvgrok trampoline). */
